    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white rounded-2xl shadow-2xl p-8">
        <div class="text-center mb-6">
          <h1 class="text-2xl font-bold text-gray-800">Welcome to shop name</h1>
        ...
        <form>
          ...
          <p class="text-center text-gray-600">
            Don't have an account? <RouterLink to="/shop/register" class="text-blue-600 hover:underline font-medium">Sign up</RouterLink>
          </p>
        </form>
      </div>
